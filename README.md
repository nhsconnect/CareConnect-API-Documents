...
- Clone the repo: `git clone https://github.com/nhsconnect/CareConnect-API-Documents`
...
Read the [Getting started page](#) for information on the CareConnect Documents API contents, templates and examples, and more.

## What's included

Within the download you'll find the CareConnect Documents API Jekyll pack.
...
Have a bug or a feature request? Please first search the existing and closed issues. If your problem or idea is not addressed yet and is relevant to the CareConnect Core API [please open a new issue](https://github.com/nhsconnect/CareConnect-API-Documents/issues).
...
See [the Releases section of our GitHub project](https://github.com/nhsconnect/CareConnect-API-Documents/releases) for changelogs for each release version of Bootstrap. Release announcement posts on [the official CareConnect API blog](#) contain summaries of the most noteworthy changes made in each release.
